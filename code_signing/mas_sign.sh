...
codesign -s $IDENTITY --entitlements /tmp/ent_child "$OUTPUT_DIR/$OUTPUT_FILE_NAME.app/Contents/Versions/$VERSION/$OUTPUT_FILE_NAME Framework.framework/Helpers/crashpad_handler"
codesign -s $IDENTITY --entitlements /tmp/ent_child "$OUTPUT_DIR/$OUTPUT_FILE_NAME.app/Contents/Versions/$VERSION/$OUTPUT_FILE_NAME Framework.framework/Versions/A/Internet Plug-Ins/nacl_irt_x86_64.nexe"
...
codesign -dvvv --entitlements :- "$OUTPUT_DIR/$OUTPUT_FILE_NAME.app/Contents/Versions/$VERSION/$OUTPUT_FILE_NAME Framework.framework/Helpers/crashpad_handler"
codesign -dvvv --entitlements :- "$OUTPUT_DIR/$OUTPUT_FILE_NAME.app/Contents/Versions/$VERSION/$OUTPUT_FILE_NAME Framework.framework/Versions/A/Internet Plug-Ins/nacl_irt_x86_64.nexe"
...
spctl --assess -vvvv "$OUTPUT_DIR/$OUTPUT_FILE_NAME.app/Contents/Versions/$VERSION/$OUTPUT_FILE_NAME Framework.framework/Versions/A/Internet Plug-Ins/nacl_irt_x86_64.nexe"
